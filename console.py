...
class HBNBCommand(cmd.Cmd):
    ...
    def do_destroy(self, inp):
        """Deletes an instance based on the class name and id and save the
    ...
    def do_update(self, line):
        ...
        updating attribute then saves the change into the JSON file.
        """
        act = ""
    ...
    def precmd(self, arg):
        """Hook before command run.
        If the self.block_command True, the command is not run.
        Otherwise, it is run.
        """
